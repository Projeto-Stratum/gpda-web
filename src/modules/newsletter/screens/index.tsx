    ...
    <>
      <div className=" bg-black relative px-[104px] md:pt-[120px] pt-[90px]">
        ...
        <div className="flex flex-wrap justify-center">
          <div className="flex flex-col w-1/2 gap-4 md:gap-12 md:flex-row">
            <div className="flex justify-center w-full">
              <div className=" w-full bg-gray-300 rounded-lg md:h-[450px] h-[300px]"></div>
            </div>
            <div className="flex flex-col justify-center w-full gap-2 md:gap-4">
              ...
              <p className="opacity-80">
                Loren ipson dolor sit amet, consectetur adipiscing elit. Donec
                ac
              </p>
